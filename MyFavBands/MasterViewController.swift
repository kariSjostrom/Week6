...
class MasterViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        listArray = ["Bach","Blackmill","Bob Marley","Count Basie", "Duke Ellington","Frank Sinatra", "Guns N Roses","Julia Holter", "Koji Kondo", "Lindsey Stirling", "Matisyahu", "Nico Vega", "Owl City", "Peter Paul and Mary", "Simon Garfunkel", "TransSiberian Orchestra", "Two Steps From Hell"]
